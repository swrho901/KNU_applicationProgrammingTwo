...
public class MainActivity extends AppCompatActivity implements MyRecyclerAdapter.MyRecyclerViewClickListener, SimpleTextAdapter.SimpleTextClickListener, OnMapReadyCallback {
    ...
    final SimpleTextAdapter adapter2 = new SimpleTextAdapter(list);
    ...
    public int[] ArrLikeNum = new int[10000];
        ...
        mFirebaseRef2.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String s) {
                for (DataSnapshot poly : snapshot.getChildren()) {
                    ...
                    ArrLikeNum[commArrIdx] = likenunu;
                    commArrIdx++;
                    ...
                    int k = 0;
                    c = snapshot.getValue(Context.class);
                    list.add(new Community(cat[0], tititi ,mainCtx,likenunu,ididid));
                }
                recyclerView2.setAdapter(adapter2);
            }
            @Override
...
/*
        ...
        String visit3[] = new String[100000];
...
*/
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker arg0) {
                ...
                it.putExtra("user_address", user_address);
                ItemData item = dataList.get(0);

                it.putExtra("content", contextArr[0]);
                it.putExtra("title", item.title);
                it.putExtra("money", item.money);
                // test 4개 데이터

                it.putExtra("title", titleArr[0]);
                it.putExtra("address", addArr[0]);
                it.putExtra("money", moneyArr[0]);
                it.putExtra("typeOfContext", typeOfContextArr[0]);
                it.putExtra("negotiation", negoArr[0]);
                it.putExtra("currentStat", currentStatArr[0]);
                startActivity(it);
