...
public class writeActivity extends AppCompatActivity {
    ...
    private void uploadContents() {
        ...
        mDatabase = database.getReference("users").child(currentUser.getUid());
        ...
        total_read_num = rand.nextInt(1000000);
        total_read_num++;
        Context context = new Context(title, "모집중", user_ad, cont
                , spinner_text, 100, 0, user_id);
