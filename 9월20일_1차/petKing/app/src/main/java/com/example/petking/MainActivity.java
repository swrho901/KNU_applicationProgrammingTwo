...
public class MainActivity extends AppCompatActivity   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabwidget01.setImageResource(R.drawable.ic_baseline_chat_24);

        ImageView tabwidget02 = new ImageView(this);
        tabwidget02.setImageResource(R.drawable.ic_baseline_comm_24);

        ImageView tabwidget04 = new ImageView(this);
        tabwidget04.setImageResource(R.drawable.ic_baseline_my_info_24);

        //탭에 이미지 생성한 것 넣어주기
        TabHost.TabSpec tabFridge = tabHost.newTabSpec("chat").setIndicator(tabwidget01);
        tabFridge.setContent(R.id.chat);
        tabHost.addTab(tabFridge);

        TabHost.TabSpec tabRecipe = tabHost.newTabSpec("comm").setIndicator(tabwidget02);
        tabRecipe.setContent(R.id.comm);
        tabHost.addTab(tabRecipe);

        TabHost.TabSpec tabBookmark = tabHost.newTabSpec("myinfo").setIndicator(tabwidget04);
        tabBookmark.setContent(R.id.myinfo);
